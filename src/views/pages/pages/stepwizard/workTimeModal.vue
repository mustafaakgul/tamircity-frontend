<template>
  <!-- Add Wallet Modal -->
  <div
    class="modal custom-modal fade multi-step"
    id="work-time"
    data-keyboard="false"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="javascript:void(0);">
             <div class="card-body">
                    <div id="calendar-workTime" class="calendar-container"></div>
                </div>
          </form>
          <!-- /Add Wallet Form -->
          ...
          <div class="booking-details booking-filter-col booking-popup">
            <div class="form-group mb-0">
              <button
                ...
                data-bs-target="#edit-wallet-success"
          ...
          $.fn[pluginName] = function (options) {
            return this.each(function () {
              if (!$.data(this, "plugin_" + pluginName)) {
                ...
                $("#calendar-workTime").simpleCalendar({
