<template> 
<!-- Header -->
<header class="header" v-if="currentPath == 'guide-dashboard' || currentPath == 'guide-notification' || currentPath == 'guide-chat' || currentPath == 'guide-bookings' || currentPath == 'guide-settings' || currentPath == 'exam-details' || currentPath == 'exam-results' || currentPath == 'guide-wallet' || currentPath == 'guide-subscription' || currentPath == 'guide-withdrawn' || currentPath == 'guide-availability' || currentPath == 'guide-reviews' || currentPath == 'guide-payment'">
    <nav class="navbar navbar-expand-lg header-nav">
        ...
        <ul class="nav header-navbar-rht header-dropdown-right">
...
<header class="header"  v-else-if="currentPath == 'user-dashboard' || currentPath == 'user-notification' || currentPath == 'user-chat' || currentPath == 'user-bookings' || currentPath == 'user-settings' || currentPath == 'user-wallet' || currentPath == 'user-reviews' || currentPath == 'user-payment'">
    <nav class="navbar navbar-expand-lg header-nav">
        <div class="navbar-header">
            <headertoggle />
            <headerlogo />
